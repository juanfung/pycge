...
common interface for analysis, including: generating instances
with different data sets; solving model instances; and 
post-processing solutions (e.g., conducting comparative statics).
